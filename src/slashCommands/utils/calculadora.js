...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('calculadora')
        .setDescription('Use uma calculadora realista.'),
    async execute(interaction) {
 
        const idPrefix = 'calculadora'
        ...
        col.on('collect', async (i) => {
            ...
            if (value === "=") {
                try {
                    ...
                    data = "";
                    extra = "Ocorreu um erro, por favor clique em AC para reiniciar";
                }
            } else if (value === "clear") {
                data = "";
                extra = "Os resultados serão exibidos aqui"
